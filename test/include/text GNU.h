/*
(C) 2023-2025 Серый MLGamer. Все свободы предоставлены.
...
#define MEMORY "Максимальный объём памяти, использовавшийся каркасом Модулярис Ядро: %zu Б.\n"
#define WHOOPSIE "Упс! Кажется, разработчик забыл убрать за собой. В памяти остались следующие блоки в количестве %zu:\n"
#define OBJECT "  Объект \"%s\" - %zu Б.\n"
#define ARRAY "  Массив \"%s\": %zu эл. по %zu Б - %zu Б.\n"
#define RESIDUAL "Остаточный объём памяти: %zu Б.\n"