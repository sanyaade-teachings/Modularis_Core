...
#include <Modularis_Core/system/interfaces/modules/effects/note/Transpose.h>
...
struct MDLRS_Transpose
{
	...
	struct MDLRS_Real_controller transposition;
	struct MDLRS_Real_controller velocity;
