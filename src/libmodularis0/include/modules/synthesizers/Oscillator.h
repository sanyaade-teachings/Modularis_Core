...
#include <Modularis_Core/system/interfaces/modules/synthesizers/Oscillator.h>
...
struct Oscillation
{
	struct Oscillation *previous, *next;
...
struct MDLRS_Oscillator
{
	...
	struct MDLRS_Integer_controller waveform;
	struct MDLRS_ADSR envelope;
	struct MDLRS_Sound output;
	struct MDLRS_Note_table pressed_table;
	struct Oscillation *pressed, *released, *unused;
};